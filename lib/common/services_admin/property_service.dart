...
import '../models_user/property_model.dart'; // Add this line
...
class PropertyService {
  ...
  Future<List<Property>> fetchAdminProperties() async {
    // Reference the Firestore instance for the admin app.
    final adminFirestore = FirebaseFirestore.instanceFor(app: Firebase.app('admin'));
    final snapshot = await adminFirestore.collection('properties').get();

    // Map each document to your Property model.
