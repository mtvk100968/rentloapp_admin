...
//   WidgetsFlutterBinding.ensureInitialized();
//
//   // Initialize the primary Firebase app (admin) automatically via google-services.json
//   await Firebase.initializeApp(
//     options: DefaultFirebaseOptions.admin,
//   );
//   print("Primary (admin) Firebase app initialized.");
//
//   // Initialize the secondary Firebase app (user) manually.
//   if (Firebase.apps.where((app) => app.name == 'user').isEmpty) {
//     try {
//       await Firebase.initializeApp(
//         name: 'user',
...
// class HomeScreen extends StatelessWidget {
//   Future<List<Property>> fetchProperties() async {
//     // Your code that fetches properties from Firestore using the user app.
//     final userFirestore = FirebaseFirestore.instanceFor(app: Firebase.app('user'));
//     QuerySnapshot snapshot = await userFirestore.collection('properties').get();
//     // Assuming you have a Property.fromDocument() constructor:
//     return snapshot.docs.map((doc) => Property.fromDocument(doc as DocumentSnapshot<Map<String, dynamic>>)).toList();
//   }
//
//   void _goToMapScreen(BuildContext context) async {
//     List<Property> properties = await fetchProperties();
//     Navigator.push(
//       context,
//       MaterialPageRoute(
...
//           center: properties.isNotEmpty
//               ? LatLng(properties.first.latitude, properties.first.longitude)
//               : const LatLng(20.5937, 78.9629), // default center if empty
//         ),
//       ),
//     );
//   }
...
//       body: Center(
//         child: ElevatedButton(
//           onPressed: () => _goToMapScreen(context),
//           child: const Text("Go to Property Map"),
//         ),
//       ),
//     );
//   }
